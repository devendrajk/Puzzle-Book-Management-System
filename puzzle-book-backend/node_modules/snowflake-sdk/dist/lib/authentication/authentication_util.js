...
const HTML_RESPONSE_HEADERS = 'HTTP/1.1 200 OK\r\nContent-Type: text/html; charset=utf-8\r\nConnection: close\r\n\r\n';
const SNOWFLAKE_DOMAIN_REGEX = /(^|\.)snowflakecomputing\.(com|cn)/;
const defaultRenderer = ({ error }) => error ??
    escapeHTML('Your identity was confirmed and propagated to Snowflake Node.js driver. ' +
