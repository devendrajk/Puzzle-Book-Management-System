...
exports.MULTIPART_PART_SIZE_BYTES = exports.MULTIPART_THRESHOLD_BYTES = void 0;
...
exports.MULTIPART_THRESHOLD_BYTES = 64 * 1024 * 1024;
/**
 ...
 */
exports.MULTIPART_PART_SIZE_BYTES = 8 * 1024 * 1024;
/**
...
if (exports.MULTIPART_PART_SIZE_BYTES % GCS_CHUNK_GRANULARITY_BYTES !== 0) {
    throw new Error(`MULTIPART_PART_SIZE_BYTES (${exports.MULTIPART_PART_SIZE_BYTES}) must be a multiple of ` +
 ...
 */
async function readChunk(fd, position, size) {
