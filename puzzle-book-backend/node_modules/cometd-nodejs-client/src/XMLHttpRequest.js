...
export class XMLHttpRequest {
    ...
    static #agentc = new httpc.Agent(XMLHttpRequest.#agentOptions);
    static #agents = new https.Agent(XMLHttpRequest.#agentOptions);
    ...
    #chooseAgent(serverURI) {
        ...
        if (proxy) {
            ...
            if (isIncluded) {
                ...
                const agentOpts = Object.assign({}, XMLHttpRequest.#agentOptions);
        ...
        return this.#secure(serverURI) ? XMLHttpRequest.#agents : XMLHttpRequest.#agentc;
    }
