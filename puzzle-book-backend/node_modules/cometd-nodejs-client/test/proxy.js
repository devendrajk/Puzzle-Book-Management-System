...
import * as nodeCometD from "../cometd-nodejs-client.js";
...
describe("proxy", () => {
    ...
    it("proxies cometd calls", done => {
        _proxy = http.createServer((request, response) => {
            const serverPort = parseInt(new URL(request.url).port);
        ...
        _proxy.listen(0, "localhost", () => {
            ...
            const cometd = new jsCometD.CometD();
    ...
    it("proxies with includes list", done => {
        ...
        _proxy.listen(0, "localhost", () => {
            ...
            const cometd1 = new jsCometD.CometD();
            ...
            cometd1.handshake(r => {
                if (r.successful) {
                    const cometd2 = new jsCometD.CometD();
